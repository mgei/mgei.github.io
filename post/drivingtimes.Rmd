...
tags: ["OSRM", "leaflet", "ggmap", "R", "hospitals", "Switzerland", "spatial", "Youtube", "maps"]
authors: [mgei]
---

> Originally published on RPubs: http://rpubs.com/mgei/drivingtimes
...
```{r previewloadplotfinal, echo=F, eval = F}

# finalmap <- readRDS("postdata/drivingtimes/finalmap.RDS")

# finalmap %>% saveRDS("postdata/drivingtimes/finalmap2.RDS")

finalmap <- readRDS("postdata/drivingtimes/finalmap2.RDS")
...
hospitals <- read_excel(path = "postdata/drivingtimes/kzp16_daten.xlsx",
                        sheet = "KZ2016_KZP16",
                        n_max = 293) %>% 
...
emergency_hospitals_geocoded <- readRDS("postdata/drivingtimes/emergency_hospitals_geocoded.RDS")
...
icons <- iconList(
  hospital = makeIcon("postdata/drivingtimes/hospital.png", iconWidth = 18, iconHeight = 18)
)
...
mindistances <- readRDS("postdata/drivingtimes/mindistances.RDS")
...
cpttimes_plotdata <- readRDS("postdata/drivingtimes/cpttimes_plotdata.RDS")
...
minraster <- readRDS("postdata/drivingtimes/minraster.RDS")
...
# switzerland %>% saveRDS("postdata/drivingtimes/switzerland.RDS")
switzerland <- readRDS("postdata/drivingtimes/switzerland.RDS")
...
```{r, eval=TRUE, echo=F}
blogdown::shortcode("youtube", "zbEZDNlFJRY")
```