...
tags: ["R", "economics", "USA", "China", "world trade", "comtradr"]
authors: [mgei]
---

> Also published on RPubs: https://rpubs.com/mgei/china-us-trade
...
q <- readRDS("postdata/china-us-trade/sample1.RDS")

us <- readRDS("postdata/china-us-trade/us.RDS")

ch <- readRDS("postdata/china-us-trade/ch.RDS")

com <- readRDS("postdata/china-us-trade/com.RDS")

srv <- readRDS("postdata/china-us-trade/srv.RDS")
